...
import profile from '../images/portfolio dp.png';
        ...
        <div className = 'w-full'>
            <div className = 'flex flex-col justify-center max-w-xs mx-auto bg-white shadow-xl rounded-xl p-5'>
                ...
                <div className = 'text-center mt-5'>
                    ...
                    <a className = 'text-xl m-1 p-1 sm:p-2 text-green-800 hover:bg-green-800 rounded-full hover:text-white transition-colors duration-300' href ="mailto:khanwarish79@gmail.com">
                        <FaEnvelope/>
